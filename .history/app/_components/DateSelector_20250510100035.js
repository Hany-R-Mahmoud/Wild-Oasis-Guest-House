...
function DateSelector({ cabin, settings, bookedDates }) {
  ...
  return (
    <div>
      ...
      <div className=" flex flex-col gap-8 p-8 bg-accent-500 text-primary-800 justify-center ">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-6">
          <p className="flex gap-2 items-baseline px-3 py-2">
            {discount > 0 ? (
              <>
        ...
        <div>
          {range?.from || range?.to ? (
            <button
              className="border border-primary-800 py-2 px-4 text-sm font-semibold w-fit"
              onClick={() => resetRange()}
            >
              Clear
            </button>
