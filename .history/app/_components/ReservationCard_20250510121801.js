...
function ReservationCard({ booking, onDelete }) {
  ...
  return (
    <div className="flex flex-col md:flex-row border border-primary-800">
      ...
      <div className="flex flex-col border-t md:border-l border-primary-800 place-items-center ">
        {/* <div className="flex flex-col border-t md:border-l border-primary-800 w-[100px]"> */}
        {!isPast(new Date(startDate)) ? (
          <>
            <Link
              href={`/account/reservations/edit/${id}`}
              className="group flex  items-center gap-2 uppercase text-xs font-bold text-primary-300 border-b border-primary-800  p-3 hover:bg-accent-600 transition-colors hover:text-primary-900"
            >
